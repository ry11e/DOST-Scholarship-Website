            ...
            <form id="edit_scholar_form" method="POST" action="update-scholar.php" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        ?>
                                <div class="row bg-warning-subtle m-1 p-1 rounded-3 align-items-center d-flex">
                                    <div class="me-2" style="width: auto;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 424 511.543">
                    ...
                    <div class="col-md-6">
                        ...
                        ?>
                                ...
                                <div class="row bg-warning-subtle m-1 p-1 rounded-3 align-items-center d-flex">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden me-auto">
                                        <a class="fs-8 text-truncate d-block fw-bold" href="uploads/scholars/<?= $scholar_id ?>/updated_cog_filename/<?= $filename ?>" target="_blank">
                                            <?= $filename ?>
                                        </a>
                                        <small class="text-muted" style="font-size: 0.7rem;">
                                            Uploaded: <?= date('m/d/y', strtotime($upload_date)) ?>
                                    ...
                                    <div class="d-flex gap-1 align-items-center">
                                        <a href="uploads/scholars/<?= $scholar_id ?>/updated_cog_filename/<?= $filename ?>"
                                            class="btn btn-outline-primary btn-sm py-0 px-4"
                                            style="font-size: 0.75rem;" download>
                                            Download
                                        </a>
                                        <button type="button"
                                            class="btn btn-outline-danger btn-sm py-1 px-4"
                                            style="line-height: 1;"
                                            onclick="removeFile('<?= $filename ?>', '<?= $scholar_id ?>', 'updated_cog_filename')">
                                            &times;
                                        </button>
                                    </div>
                                </div>
