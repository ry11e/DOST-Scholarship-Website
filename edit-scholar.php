                                ...
                                <div class="row bg-warning-subtle m-1 p-2 rounded-3 align-items-center d-flex flex-nowrap w-100 overflow-hidden">
                                    <div class="d-flex align-items-center flex-grow-1 overflow-hidden" style="max-width:75%;">
                                        ...
                                        <div class="overflow-hidden">
                                            <a class="fs-8 text-truncate d-block fw-bold mb-0" href="uploads/scholars/<?= $scholar_id ?>/periodic_requirements/<?= $filename ?>" target="_blank" style="text-decoration: none;">
                                                <?= $filename ?>
                                            </a>
                                            <small class="text-muted d-block" style="font-size: 0.65rem; margin-top: -3px;">
                        ...
                        ?>
                                ...
                                <div class="row bg-warning-subtle m-1 p-2 rounded-3 align-items-center d-flex flex-nowrap w-100 overflow-hidden">
                                    <div class="d-flex align-items-center flex-grow-1 overflow-hidden" style="max-width:75%;">
                                        ...
                                        <div class="overflow-hidden">
                                            <a class="fs-8 text-truncate d-block fw-bold mb-0 text-decoration-none" href="uploads/scholars/<?= $scholar_id ?>/updated_cog_filename/<?= $filename ?>" target="_blank">
                                                <?= $filename ?>
                                            </a>
                                            <small class="text-muted d-block" style="font-size: 0.65rem; margin-top: -3px;">
                                                Uploaded: <?= date('m/d/y', strtotime($upload_date)) ?>
