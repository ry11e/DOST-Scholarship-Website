    ...
    <div class="xs-pd-20-10 pd-ltr-20">
        ...
        <div class="card-box pd-50">
            ...
            <form method="GET" action="">
                ...
                <div class="row g-3 row-cols-1 row-cols-md-3 row-cols-lg-5 my-1 justify-content-center">

                    <div class="col d-flex justify-content-center align-items-center gap-2 mt-1">
                        <button type="submit" class="btn btn-primary">Search</button>

                        <a href="dashboard.php" onclick="resetScholarTable()" class="btn btn-secondary">
            ...
            <div class="bg-secondary-subtle border rounded-top-2 pb-2 mt-3 ">
                ...
                <table id="dashboard-table" class="data-table table no-wrap table-hover table-bordered table-striped">
                    <thead>
                        <tr style="background-color: rgba(0, 0, 0, 0.39);">
                            <th class="table-plus all" data-priority="1" style="width: 5%;">#</th>
                            <th class="datatable" data-priority="2" style="width: 8%;">YEAR OF AWARD</th>
                            <th class="datatable" data-priority="2" style="width: 11%;">SCHOLARSHIP PROGRAM</th>
                            <th class="datatable" data-priority="1" style="width: 25%;">NAME OF SCHOLAR</th>
                            ...
                            <th class="datatable" data-priority="2" style="width: 10%;">STATUS</th>
                            ...
                            <th class="datatable-nosort" data-priority="2" style="width: 11%;">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        // Execute the query and get the scholars
                        $result = $conn->query($sql);

                        $periodicFilesSql = "Select * from uploaded_files Where fld_upload_type = 'periodic_requirements' and fld_record_status = 'active'";
                        $updatedCOGSql = "Select * from uploaded_files Where fld_upload_type = 'updated_cog_filename'  and fld_record_status = 'active'";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td> <div class='cell-content'>" . $row['name'] . " </div> </td>";
                            echo "<td> <div class='cell-content'>" . $row['school'] . " </div> </td>";
                            echo "<td> <div class='cell-content'>" . $row['course'] . " </div> </td>";
                            ...
                            foreach ($periodicFilesArray as $periodicFile) {
                                if ($periodicFile['fld_scholar_ID'] == $scholarId) {
                                    ...
                                    echo "<p style='font-size: 12px; background-color:beige;'>
                                                ...
                                                <a href='uploads/scholars/$id/periodic_requirements/$filename' target='_blank'>$filename</a>
                                                <br>";
                            ...
                            foreach ($updatedCOGsArray as $updatedCOG) {
                                if ($updatedCOG['fld_scholar_ID'] == $scholarId) {
                                    ...
                                    echo "<p style='font-size: 12px; background-color:beige;'>
                                                ...
                                                <a href='uploads/scholars/$id/updated_cog_filename/$filename' target='_blank'>$filename</a>
                                                <br>";
...
<script>
    ...
    // Since we can't display the total no of scholars until AFTER the retrieval, we first let the script retrieve the records, then send it to the top
    if (document.getElementById('dashboard-total-results-display')) {
        document.getElementById('dashboard-total-results-display').innerText = "" + (<?= htmlspecialchars($result->num_rows) ?>);
    }

    // Confirmation function for delete scholar
