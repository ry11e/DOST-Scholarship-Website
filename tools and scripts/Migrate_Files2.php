...
//-----------
$fieldToChange = "periodic_requirements";    // <------- This is the field you want to migrate
...
while ($row = $result->fetch_assoc()) {
    $scholarId = $row['id'];
    $scholarFolder = $baseTargetDir . $scholarId . "/" . $fieldToChange . "/";
    ...
    $files = array_map('trim', explode(',', $row[$fieldToChange]));
    ...
    foreach ($files as $fileEntry) {
        ...
        $oldPath = $sourceDir . "scholars/" . $scholarId . "/" .$filename;
